...
flowchart LR
  ...
  svc_authorizationController["ctx.authorizationController<br/>Host account sign-in Remote controller"]
...
| `ctx.authorizationController` | `core` | [`api-settings-controller`](../packages/api/settings-controller) | - | - | - | Projects authorization methods, credential presence, cancellable sign-in prompts, and sign-out onto the generated Remote namespace. |
