...
来源：[`packages/core/agent-default-model/src/index.ts:74`](../packages/core/agent-default-model/src/index.ts)
...
需要：`agentModels` · `agents` · `sessions`
...
需要：`agentModels` · `agents` · `attachments` · `directoryPicker` · `llm` · `sessions` · `subagents` · `sessionQuery` · `tools` · `userInteraction` · `workspace`
...
来源：[`packages/guard/tool-policy-enforcer/src/index.ts:25`](../packages/guard/tool-policy-enforcer/src/index.ts)
...
来源：[`packages/web/web-search-openrouter/src/index.ts:50`](../packages/web/web-search-openrouter/src/index.ts)
