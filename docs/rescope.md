...
- **Product protocol and UI identifiers.** Event names such as `cordis/request-run`, the `cordis` locale namespace, and the `cordis` input-source id are not module specifiers.
