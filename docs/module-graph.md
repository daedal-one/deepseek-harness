...
flowchart TD
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_device_access["client-ui-device-access"]
  ...
  pkg_client_connection --> pkg_subprocess
  ...
  pkg_openrouter_spend --> pkg_credentials
  pkg_openrouter_spend --> pkg_launch_environment
  pkg_openrouter_spend --> pkg_session
  pkg_openrouter_spend --> pkg_session_projection
  pkg_openrouter_spend --> pkg_typert_protocol
  ...
  pkg_local_container_runtime --> pkg_agent_presets
  pkg_local_container_runtime --> pkg_fs
  pkg_local_container_runtime --> pkg_shell
  pkg_local_container_runtime --> pkg_subprocess
  ...
  pkg_daedal_handoff --> pkg_agent
  pkg_daedal_handoff --> pkg_agent_presets
  pkg_daedal_handoff --> pkg_api_session_controller
  ...
  pkg_daedal_handoff --> pkg_system_prompt
  pkg_daedal_handoff --> pkg_tools
  pkg_daedal_handoff --> pkg_user_questions
...
| [`client-ui-device-access`](../packages/client/ui-device-access) | `client` | — |
...
| [`memory`](../packages/memory/memory) | `memory` | [`brand`](../packages/util/brand) |
...
| [`client-connection`](../packages/client/connection) | `client` | [`subprocess`](../packages/subprocess/subprocess) |
...
| [`openrouter-spend`](../packages/llm/openrouter-spend) | `llm` | [`credentials`](../packages/credentials/credentials), [`launch-environment`](../packages/util/launch-environment), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`typert-protocol`](../packages/typert/protocol) |
...
| [`tool-policy-enforcer`](../packages/guard/tool-policy-enforcer) | `guard` | [`sandbox`](../packages/sandbox/sandbox), [`sandbox-policy`](../packages/sandbox/sandbox-policy), [`session`](../packages/core/session), [`tool-policy`](../packages/guard/tool-policy), [`tools`](../packages/core/tools), [`user-approval`](../packages/interaction/user-approval) |
...
| [`subagent-result-status-block`](../packages/subagent/subagent-result-status-block) | `subagent` | [`agent`](../packages/core/agent), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent) |
