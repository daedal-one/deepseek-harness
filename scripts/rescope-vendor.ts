...
const POSTCONDITIONS: readonly PostCondition[] = [
  ...
  // These are product protocol and UI identifiers, not package references.
  { file: 'packages/extensions/cordis-host-runner/src/types.ts', text: "    'cordis/request-run'(request:", count: 1 },
