...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-device-access': { kind: 'none', reason: 'Browser-owner device administration; registers no model inputs or Session events.' },
  ...
  'packages/client/ui-openrouter-spend': { kind: 'none', reason: 'Browser-side OpenRouter spend presentation; it renders a Host reading and registers nothing model-facing.' },
  'packages/integration/forge-project-workspaces': { kind: 'none', reason: 'Host-side Forge project reconciliation and browser selection register nothing model-facing.' },
