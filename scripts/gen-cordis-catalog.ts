...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  connectionDevices: 'client-side interface-typed browser-owner administration — packages/client/connection/README.md#device-enrollment owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionHistoryDetailRequest: 'session.md',
  SessionEventEntry: 'session.md',
  ...
  WorkspaceCheckpointRuntime: 'sandbox.md',
  WorkspaceExecutionRuntime: 'sandbox.md',
  ConversationWorkspaceId: 'sandbox.md',
  DevelopmentVmDescriptor: 'sandbox.md',
  DevelopmentVmNetworkPolicy: 'sandbox.md',
  DevelopmentVmOpenRequest: 'sandbox.md',
  DevelopmentVmReference: 'sandbox.md',
  ...
  MemoryChallenge: 'memory.md',
  MemoryCheckpoint: 'memory.md',
  MemoryEvidence: 'memory.md',
  MemoryId: 'memory.md',
  MemoryProposal: 'memory.md',
  MemoryProvider: 'memory.md',
  MemoryQuery: 'memory.md',
  MemoryQueryResult: 'memory.md',
  MemoryRecord: 'memory.md',
  MemoryRef: 'memory.md',
  MemoryReview: 'memory.md',
  MemoryScope: 'memory.md',
  MemoryStatus: 'memory.md',
  MemorySupersession: 'memory.md',
  MemoryTrust: 'memory.md',
  MemoryValidity: 'memory.md',
  ...
  SubagentChildSetupContribution: 'subagent.md',
  ...
  SubagentPrincipal: 'subagent.md',
  SubagentProvider: 'subagent.md',
  SubagentRun: 'subagent.md',
  SubagentResultValidationRequest: 'subagent.md',
  SubagentResultValidator: 'subagent.md',
  SubagentResultWarning: 'subagent.md',
  ...
  ProviderAccount: 'settings.md',
  ProviderAccountUpdate: 'settings.md',
  AccountAttemptId: 'settings.md',
  AccountPromptId: 'settings.md',
...
export function main(): void {
  ...
  console.log(`gen-cordis-catalog: ${outputs.length} artifact(s) computed, ${changed} written.`)
}
