/**
 * Region-splice coverage for the Cordis catalog generator: `spliceRegion`
 * replaces exactly the marker-delimited cordis-surface region and fails loud
 * when the markers are missing, foreign, or duplicated.
 */
