...
- **With-key:** send a live-model prompt and verify external state, not the model's claim. Shipped conversation-model examples self-skip without `OPENROUTER_API_KEY`; see [testing.md](../docs/testing.md).
