...
- `source`: repository-relative canonical Markdown path. Add the canonical English `.md` path with content locale `en-US`.
...
English sources project to one root route tree.
