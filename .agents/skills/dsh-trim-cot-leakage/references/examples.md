...
### Authoring-language slip inside a quoted fence

**Leaked:** `// Update this before returning` inside a verbatim code block.

**Fixed:** `// Update this before returning.`

Correct the owning block and regenerate any verbatim copies from that source.
