...
The default route is `openrouter` with `deepseek/deepseek-v4.1-flash`. The `api_key` and `base_url` options configure OpenRouter; other routes use their profile configuration and explicit environment overrides.
