...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-retry, steering, system-prompt, tool-call, turn-error, turn-max-tokens, turn-process, turn-tail, unknown, user, workflow-run, workspace-admission, workspace-state',
    ...
    occupants: [
      'client-ui-chat WorkspaceAdmissionNodeView key \'workspace-admission\'',
      'client-ui-chat WorkspaceStateNodeView key \'workspace-state\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-openrouter-spend SpendView id \'spend\'',
