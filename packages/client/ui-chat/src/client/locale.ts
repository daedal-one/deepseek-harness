...
export const en = {
  'workspace.waiting': 'Waiting for workspace capacity…',
  'workspace.admissionFailed': 'Workspace could not start',
  ...
  'chat.reconnecting': 'Reconnecting… showing the last loaded messages',
