...
export type PluginsSettingsLocaleKey =
  ...
  | 'webSearchModel' | 'webSearchModelHint' | 'webSearchEngine' | 'webSearchEngineHint'
...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchDescription: 'OpenRouter-routed search with provider-native or hosted retrieval.',
  ...
  webSearchModelHint: 'OpenRouter model used for the auxiliary search request.',
  webSearchEngine: 'Search engine',
  webSearchEngineHint: 'auto prefers provider-native search and otherwise uses a hosted engine.',
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchTitle: '网页搜索',
  webSearchDescription: '通过 OpenRouter 路由，使用提供方原生或托管检索的搜索。',
  webSearchApiKey: 'API Key',
  ...
  webSearchModel: '搜索模型',
  webSearchModelHint: '用于辅助搜索请求的 OpenRouter 模型。',
  webSearchEngine: '搜索引擎',
  webSearchEngineHint: 'auto 优先使用提供方原生搜索，否则使用托管引擎。',
