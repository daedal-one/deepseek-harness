...
export function HoverCard({
  ...
  copyText, copyLabel = 'Copy', copiedLabel = 'Copied',
}: {
  anchor: ReactNode
  content: ReactNode
  openDelayMs?: number
