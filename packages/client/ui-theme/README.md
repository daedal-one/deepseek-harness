...
The built-in palettes coordinate with the Daedal Paseo companion: neutral light surfaces, green-tinted dark surfaces, and green links and accents. Shared semantic tokens apply these colors to navigation, the composer, dialogs, and conversation content. Status and syntax colors keep their independent meanings.
