...
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'Sign in to an account or enter an API key to use these providers.',
  account: 'Account',
  accountSignedIn: 'Signed in',
  accountSignedOut: 'Not signed in',
  accountSignOut: 'Sign out',
  accountBusy: 'Signing in…',
  accountContinue: 'Continue sign-in',
  accountSubmit: 'Continue',
  accountFailed: 'Account sign-in failed. Please try again.',
  accountLoadFailed: 'Account status could not be loaded. Please try again.',
  accountCancelled: 'Sign-in cancelled.',
  accountSignOutFailed: 'Sign-out failed. Please try again.',
  edit: 'Edit',
