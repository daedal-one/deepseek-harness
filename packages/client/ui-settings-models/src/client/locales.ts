...
export const en = {
  ...
  accountMissing: 'Account sign-in required',
  accountSignIn: 'Sign in with OpenAI',
  accountStarting: 'Starting sign-in…',
  accountPreparing: 'Preparing device sign-in…',
  accountDeviceInstructions: 'Enter this code on the OpenAI page:',
  accountOpenVerification: 'Open OpenAI',
  accountCancel: 'Cancel sign-in',
  accountCancelling: 'Cancelling…',
  ...
  onboardingDescription: 'Add your OpenRouter API key to use the configured Agent models.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  accountMissing: '需要登录账号',
  accountSignIn: '使用 OpenAI 登录',
  accountStarting: '正在开始登录…',
  accountPreparing: '正在准备设备登录…',
  accountDeviceInstructions: '请在 OpenAI 页面输入此代码：',
  accountOpenVerification: '打开 OpenAI',
  accountCancel: '取消登录',
  accountCancelling: '正在取消…',
  accountCancelled: '登录已取消。',
  accountSignOut: '退出登录',
  ...
  onboardingDescription: '添加 OpenRouter API 密钥，即可使用已配置的 Agent 模型。',
