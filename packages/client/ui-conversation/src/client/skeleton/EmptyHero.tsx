...
export interface HeroShellProps {
  ...
  t: HeroTranslate
  /** Live product identity rendered by the hero mark. */
 ...
 */
export function HeroShell({ t, branding, children }: HeroShellProps) {
  return (
      ...
      <div className={css.stack}>
        <div className={css.headline}>
          ...
          <span className={css.fishHitbox}>
            <BrandLogo name={branding.name} logo={branding.logo} size={34} className={css.fish} />
          </span>
