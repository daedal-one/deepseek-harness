...
export const en = {
  ...
  'access.environment.host': 'Host',
  'access.environment.container': 'Container',
  'access.environment.external': 'External environment',
  'access.environment.unknown': 'Environment unverified',
  'access.environmentDetail.host': 'Runs on the host · file access follows this policy',
  'access.environmentDetail.container': 'Runs in a container · this policy cannot grant host access',
  'access.environmentDetail.external': 'Runs externally · isolation has not been verified',
  'access.environmentDetail.unknown': 'Execution environment has not been verified',
  'access.profileDefault': 'Profile default',
  'access.sessionOverride': 'Override for this session',
  'access.fixed': 'Access is fixed · choose another policy in a new session',
  'access.preset.readOnly': 'Read Only',
  'access.preset.readOnly.description': 'Inspect files and run commands without changing files. Actions that need write access ask for approval.',
  'access.preset.workspaceWrite': 'Workspace Write',
  'access.preset.workspaceWrite.description': 'Read and edit files in the workspace. Actions outside the workspace or other sensitive operations ask for approval.',
  'access.preset.fullAccess': 'Full access',
  'access.preset.fullAccess.description': 'Read, edit, and run commands within the displayed environment without routine approval. This policy does not grant access beyond that environment. Use only for trusted tasks.',
