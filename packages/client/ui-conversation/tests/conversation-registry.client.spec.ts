...
function fakeSession(): SessionFace {
  ...
  return {
    ...
    retryOpen: () => Promise.reject(new Error('unused fake Session operation')),
    loadHistoryDetail: () => Promise.reject(new Error('unused fake Session operation')),
...
function fakeSessions(ctx: Context): { sessions: ISessions; binding: SessionBinding } {
  ...
  const sessions = {
    ...
    loadSummary: () => Promise.reject(new Error('unused fake Sessions operation')),
    ...
    forkTo: () => Promise.reject(new Error('unused fake Sessions operation')),
