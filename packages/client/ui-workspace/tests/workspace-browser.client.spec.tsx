...
const t: WorkspaceBrowserProps['t'] = makeTranslate(copy, commonCopy)
...
function mount(overrides: Partial<WorkspaceBrowserProps> = {}) {
  ...
  const props: WorkspaceBrowserProps = {
    ...
    useHostInfo: selector => selector({ home: undefined, identity: undefined, isLoopback: true }),
  ...
  it('workspace hover card shows a POSIX home descendant as ~', () => {
    ...
    try {
      mount({
        ...
        useHostInfo: selector => selector({ home: '/home/u', identity: undefined, isLoopback: true }),
      })
