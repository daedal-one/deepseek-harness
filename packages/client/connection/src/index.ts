 ...
 * layer exists. Provider account state and every authentication operation are
 * credential-plane data and actions, so they are pinned with it.
...
const PRIVILEGED_METHODS = new Set([
  ...
  'credentials.unset',
  'llm.discoverModels',
  'llm.providerAuthState',
  'llm.startProviderAuth',
  'llm.providerAuthStatus',
  'llm.cancelProviderAuth',
  'llm.logoutProviderAuth',
])
