...
The browser roster mounts [ui-branding](../../client/ui-branding/README.md), so the visible product identity defaults to `the harness` and loopback users can persist their own name and logo without changing the bundle.
