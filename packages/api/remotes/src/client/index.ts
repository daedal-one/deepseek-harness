...
import agentModelsRemote from '@deepseek-ai/dsh-agent-default-model/remote'
...
export type { AgentModelsSnapshot } from '@deepseek-ai/dsh-agent-default-model/types'
...
export type {
  ...
  RpcRequest, RpcResponse, RpcResult, SessionId, SessionListCursor, SessionModels, SessionSearchItem,
  ...
  WorkspaceId, WorkspaceView, ProviderAuthMethodView, ProviderAuthOperationView,
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      agentModelsRemote, commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote,
    ]) {
