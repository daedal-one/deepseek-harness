...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_agents', 'list_agents', 'list_subagent_models', 'lsp', 'memory_challenge', 'memory_checkpoint', 'memory_delete', 'memory_get', 'memory_list_pending', 'memory_propose', 'memory_query', 'memory_review', 'memory_supersede', 'present', 'pwsh', 'pwsh', 'ralph',
