...
const scopedSubjectResolvers: Readonly<Record<string, ScopedSubjectResolver | null>> = Object.freeze({
  ...
  'agent/prepare': args => (args[0] as Record<string, unknown>)['agent'],
  ...
  'agent/turn-settled': args => (args[0] as Record<string, unknown>)['agent'],
  'agent/turn-starting': args => (args[0] as Record<string, unknown>)['agent'],
