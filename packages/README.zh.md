...
| [`mcp/`](mcp/README.md) | 外部 Model Context Protocol 工具桥接 | 产品：稳定 API |
| [`memory/`](memory/README.md) | 持久化评审记忆 seam、SQLite 提供方、提取器和限定 scope 的 Consumer | 产品：稳定 API |
...
| [`guard/`](guard/README.md) | 循环卫生、工具授权策略与可审计模型输出 guard | 产品：稳定 API |
