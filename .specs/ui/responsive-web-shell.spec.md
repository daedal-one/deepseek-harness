...
- {#c-document-scroll} Below the phone breakpoint, the Chat transcript MUST use the main document as its vertical scroll owner so mobile browsers can retract their chrome, while preserving bottom-follow, semantic position restoration, prepend anchoring, the back-to-bottom action, and sticky composer reachability.
