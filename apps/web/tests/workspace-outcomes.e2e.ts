...
it('keeps workspace return and pending recovery visible beside a completed model answer', async () => {
  ...
  try {
    ...
    expect(await returned.innerText()).toContain('dsh/aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/main/turn-1')
